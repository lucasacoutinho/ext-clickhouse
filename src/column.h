...
typedef enum {
    ...
    CH_TYPE_DYNAMIC,
    /* Interval types */
    CH_TYPE_INTERVAL_NANOSECOND,
    CH_TYPE_INTERVAL_MICROSECOND,
    CH_TYPE_INTERVAL_MILLISECOND,
    CH_TYPE_INTERVAL_SECOND,
    CH_TYPE_INTERVAL_MINUTE,
    CH_TYPE_INTERVAL_HOUR,
    CH_TYPE_INTERVAL_DAY,
    CH_TYPE_INTERVAL_WEEK,
    CH_TYPE_INTERVAL_MONTH,
    CH_TYPE_INTERVAL_QUARTER,
    CH_TYPE_INTERVAL_YEAR
} clickhouse_type_id;
